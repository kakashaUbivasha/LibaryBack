...
class RecommendationController extends Controller
{
    public function index(GeminiService $gemini){
        ...
        $prompt .= "\nНа основе этих книг определи предпочтения пользователя и предложи 5–7 новых книг, которые ему точно подойдут. Учитывай жанры, атмосферу и стиль произведений.
